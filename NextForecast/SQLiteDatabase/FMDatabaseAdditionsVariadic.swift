...
extension FMDatabase {
    ...
    func stringForQuery(sql: String, _ values: AnyObject...) -> String! {
        return valueForQuery(sql, values: values as NSArray as [AnyObject]) { $0.stringForColumnIndex(0) }
    }
    ...
    func intForQuery(sql: String, _ values: AnyObject...) -> Int32! {
        return valueForQuery(sql, values: values as NSArray as [AnyObject]) { $0.intForColumnIndex(0) }
    }
    ...
    func longForQuery(sql: String, _ values: AnyObject...) -> Int! {
        return valueForQuery(sql, values: values as NSArray as [AnyObject]) { $0.longForColumnIndex(0) }
    }
    ...
    func boolForQuery(sql: String, _ values: AnyObject...) -> Bool! {
        return valueForQuery(sql, values: values as NSArray as [AnyObject]) { $0.boolForColumnIndex(0) }
    }
    ...
    func doubleForQuery(sql: String, _ values: AnyObject...) -> Double! {
        return valueForQuery(sql, values: values as NSArray as [AnyObject]) { $0.doubleForColumnIndex(0) }
    }
    ...
    func dateForQuery(sql: String, _ values: AnyObject...) -> NSDate! {
        return valueForQuery(sql, values: values as [AnyObject]) { $0.dateForColumnIndex(0) }
    }
    ...
    func dataForQuery(sql: String, _ values: AnyObject...) -> NSData! {
        return valueForQuery(sql, values: values as [AnyObject]) { $0.dataForColumnIndex(0) }
    }
}
